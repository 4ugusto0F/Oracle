...
public class VideoGame {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner input = new Scanner(System.in)) {
            ...
            Premios_Das_Categorias[] categoriasDePremios = terminal.criarCategoriasDePremios();

            Cartao cartao1 = Cartao.criarCartao();
            Cartao cartao2 = Cartao.criarCartao();

            terminal.aceitarDinheiro(cartao1, 100);
            terminal.aceitarDinheiro(cartao2, 100);

            Jogo jogo1 = new Jogo("Roleta dos Tickets", 10, false);
            Jogo jogo2 = new Jogo("Tickets da Sorte", 5, true);
                ...
                System.out.print("Escolha uma opção: ");
                    ...
                    switch (opcaoMenu) {
                        ...
                        case 2:
                            ...
                            Cartao cartaoAdicionarCreditos = null;
                        ...
                        case 3:
                            ...
                            Cartao cartaoOrigem = null;
                            Cartao cartaoDestino = null;
                        ...
                        case 4:
                                ...
                                Cartao cartaoOrigem2 = null;
                                Cartao cartaoDestino2 = null;
                        ...
                        if (cartaoResgate != null) {
                            ...
                            for (int count = 0; count < categoriasDePremios.length; count++) {
                                Premios_Das_Categorias categoria = categoriasDePremios[count];
                            ...
                            if (opcaoCategoria > 0 && opcaoCategoria <= categoriasDePremios.length) {
                                Premios_Das_Categorias categoriaPremio = categoriasDePremios[opcaoCategoria - 1];
