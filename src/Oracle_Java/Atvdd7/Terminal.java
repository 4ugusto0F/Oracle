...
public class Terminal {
    ...
    public Terminal() {
        ...
        public Premios_Das_Categorias[] criarCategoriasDePremios() {

        Premios_Das_Categorias ursoDePelucia = new Premios_Das_Categorias("Urso de Pelúcia", 100, 1);
        Premios_Das_Categorias tigreDePelucia = new Premios_Das_Categorias("Tigre de Pelúcia", 100, 1);
        Premios_Das_Categorias vacaDePelucia = new Premios_Das_Categorias("Vaca de Pelúcia", 100, 1);
        
        Premios_Das_Categorias[] categoriasDePremios = {ursoDePelucia, tigreDePelucia, vacaDePelucia};
        
        return categoriasDePremios;
    }


    public void aceitarDinheiro(Cartao cartao, int valorDinheiro) {
        if (valorDinheiro >= 1) {
    ...
    public void transferirCreditos(Cartao cartaoOrigem, Cartao cartaoDestino, double quantidadeCreditos) {
    ...
    public void transferirTickets(Cartao cartaoOrigem, Cartao cartaoDestino, int quantidadeTickets) {
    ...
    public void verificarSaldoDoCartao(Cartao cartao) {
        imprimirSaldoDoCartao(cartao);
    }
    
    public void trocarTicketsPorPremio(Cartao cartao, Premios_Das_Categorias categoriaPremio) {
    ...
    private void imprimirSaldoDoCartao(Cartao cartao) {
